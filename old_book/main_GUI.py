...
class main_gui():
    ...
    def init_gui(self):
        ...
        self.book2_label1 = Label(self.book_main, text="", font=("Sunflower", "15"))
        self.book2_label1.place(x=50, y=140)
        self.book2_label2 = Label(self.book_main, text="", font=("Sunflower", "12"), fg='#ff0000')
        self.book2_label2.place(x=50, y=180)
    ...
    def new_book(self):
        ...
        for book in self.newBook:
            self.book2_label1.configure(text=book.title)
            self.book2_label2.configure(text=book.original_price)

        book2_button2 = Button(self.book_main, text="구매하기", relief=GROOVE, font=("Sunflower", "10"),
                               command=self.buy_book)
        book2_button2.place(x=130, y=180)
